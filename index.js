...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    const lowerCaseNamesStrings = zooAnimals.map(item => item.animal_name.toLowerCase());
    return lowerCaseNamesStrings;
  }
  ...
  */
  ...
  function lowPopulationAnimals(){
    const lowPopulationAnimalsNames = zooAnimals.filter(item => item.population < 5)
    return lowPopulationAnimalsNames;
  }
  ...
  */
  ...
  function USApop(){
    const totalPopulation = zooAnimals.reduce((accumulator,item) =>{
